...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (192671)and invalid_reason is null
...
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4071070,194158,4048601,4048286)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4071070,194158,4048601)
  and c.invalid_reason is null
